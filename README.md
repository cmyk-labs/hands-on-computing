...
| **Machine Learning & scikit-learn** | Three sample chapters cover learning tasks and estimator interfaces, data splits and baselines, and regression and classification metrics; planned topics include preprocessing and pipelines, regression and classification algorithms, ensembles, model selection, feature engineering and interpretation, dimensionality reduction, clustering, mixture models and anomaly detection, semi-supervised and online learning, model persistence and integrated practice, with mathematical derivations, Python implementations, scikit-learn and selected PyTorch comparisons. | [Contents and plan](content/AI原理与应用/machine-learning&scikit-learn/plan.md) |
