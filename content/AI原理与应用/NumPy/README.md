...
2026-09-23 按新协议逐章检查全部 26 章、532 个 Code 单元、数据与每张图示。环境为 Windows、CPython 3.12.14、NumPy 2.5.3。第 02–08、10、12–16、18、20、21、23、26 章共 390 个 Code 单元完成空内核重跑并保存输出；其他 8 章核对既有输出。52 个预期异常逐项匹配。普通计算已删除多余输入防护，条件失效反例直接展示原始异常；数据质量/接口机制专题保留对应教学分支。未增加跨平台或其他数值后端验收。
